...
{
   TEST_ASSERT_EQUAL_INT(16, meetup_day_of_month(2013, 1, "teenth", "Wednesday"));
}

void test_wednesteenth_of_February_2013(void)
{
   TEST_ASSERT_EQUAL_INT(13, meetup_day_of_month(2013, 2, "teenth", "Wednesday"));
}

void test_wednesteenth_of_June_2013(void)
{
   TEST_ASSERT_EQUAL_INT(19, meetup_day_of_month(2013, 6, "teenth", "Wednesday"));
}
...
{
   TEST_ASSERT_EQUAL_INT(19, meetup_day_of_month(2013, 10, "teenth", "Saturday"));
}
...
{
   TEST_ASSERT_EQUAL_INT(10, meetup_day_of_month(2013, 7, "second", "Wednesday"));
}

void test_second_Wednesday_of_August_2013(void)
{
   TEST_ASSERT_EQUAL_INT(14, meetup_day_of_month(2013, 8, "second", "Wednesday"));
}
...
{
   TEST_ASSERT_EQUAL_INT(10, meetup_day_of_month(2013, 10, "second", "Thursday"));
}
...
{
   TEST_ASSERT_EQUAL_INT(24, meetup_day_of_month(2013, 7, "fourth", "Wednesday"));
}

void test_fourth_Wednesday_of_August_2013(void)
{
   TEST_ASSERT_EQUAL_INT(28, meetup_day_of_month(2013, 8, "fourth", "Wednesday"));
}
...
{
   TEST_ASSERT_EQUAL_INT(24, meetup_day_of_month(2013, 10, "fourth", "Thursday"));
}
